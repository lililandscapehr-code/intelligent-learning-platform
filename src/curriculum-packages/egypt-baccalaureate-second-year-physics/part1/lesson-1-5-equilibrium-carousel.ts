...
export const lesson15EquilibriumCarousel: EduCarouselConfig = {
  ...
  slides: [
    ...
    },
    {
      ...
      questionText: "A uniform beam (weight 200N, length 4m) rests on two supports at its ends. A 500N load hangs 1m from the left end. What are the two support reaction forces $R_1$ (left) and $R_2$ (right)?",
      imageLayout: "left",
    ...
    },
    {
      ...
      questionText: "A ladder (weight 150N, length 5m) leans against a smooth wall at 60° to horizontal. Bottom of ladder on rough floor. A man (weight 600N) stands 2m up the ladder. Find the wall reaction force (normal, horizontal).",
      imageLayout: "left",
