...
export const lesson16PowerCarousel: EduCarouselConfig = {
  ...
  slides: [
    ...
    },
    {
      ...
      questionText: "Two students run up the same staircase (h=4m). Student A takes 4s, Student B takes 8s. Both have mass 60kg. Who did more WORK? Who used more POWER?",
      imageLayout: "left",
    ...
    },
    {
      ...
      questionText: "An electric motor lifts a 200kg crate 8m in 10s. The motor draws 2000W from the power supply. Find its efficiency. (g=10m/s²)",
      imageLayout: "left",
