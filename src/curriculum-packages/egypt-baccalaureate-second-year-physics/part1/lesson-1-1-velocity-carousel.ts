  ...
  processSteps: [
    {
      ...
      subtitle: "The Nile Crossing Phenomenon",
      mission: "Look at the situation and commit your prediction before any formula.",
      brief: "A boat aims straight across but current pushes it — where does it actually go?",
      studentOutcome: "Recognize that velocity is a vector and two velocities combine.",
      parentHint: "The student is exercising prediction skills — errors here are expected and valuable.",
      preparationStages: ["Observe boat and current", "Draw arrows on paper before answering"],
      evaluationStages: ["Prediction committed", "Direction of resultant reasoned"],
      successSignal: "Student recognizes the boat moves at an angle to its heading.",
      supportDecision: "Draw the two arrows separately and ask which is longer."
    },
    {
      id: "step-measure-components",
      title: "2 · Measure & Decompose",
      subtitle: "Breaking Vectors into Components",
      mission: "Decompose any velocity into x and y components and verify with Pythagoras.",
      brief: "Use right-triangle geometry to find component magnitudes.",
      studentOutcome: "Correctly write $v_x = v\\cos\\theta$ and $v_y = v\\sin\\theta$.",
      parentHint: "The student is practising vector decomposition — a core exam skill.",
      preparationStages: ["Label axes (x = river flow, y = across river)", "Identify angle of boat's heading"],
      evaluationStages: ["Components written with correct trig function", "Resultant verified with Pythagoras"],
      successSignal: "Student recovers the magnitude using $|v| = \\sqrt{v_x^2 + v_y^2}$.",
      supportDecision: "Draw the right triangle and ask the student to label the hypotenuse."
    },
    {
      id: "step-name-law",
      title: "3 · Name the Law",
      subtitle: "Relative Velocity",
      mission: "Introduce the formal definition of relative velocity after evidence is clear.",
      brief: "Velocity of A relative to B = velocity of A minus velocity of B.",
      studentOutcome: "Apply $\\vec{v}_{AB} = \\vec{v}_A - \\vec{v}_B$ to river, train, and aircraft problems.",
      parentHint: "The student is now making the concept formal — this is the naming stage.",
      preparationStages: ["Compare observer on shore vs observer on boat", "Subtract vectors algebraically"],
      evaluationStages: ["Correct sign convention used", "Direction and magnitude both answered"],
      successSignal: "Student correctly computes velocity of boat relative to ground.",
      supportDecision: "Use a number-line analogy: if you run at +5 on a train going +60, you move at +65 relative to ground."
    },
    {
      id: "step-transfer",
      title: "4 · Transfer & Evaluate",
      subtitle: "Trains, Aircraft, and Exam Problems",
      mission: "Apply the same vector logic to two new contexts.",
      brief: "Solve a train passenger problem and an aircraft crosswind problem.",
      studentOutcome: "Confidently solve any 2-D relative velocity problem using components.",
      parentHint: "The student is transferring the model to new situations — the hardest and most valuable step.",
      preparationStages: ["Draw velocity triangle for new problem", "Identify which velocity is 'relative to ground'"],
      evaluationStages: ["Correct final speed and direction", "Checks reasonableness of answer"],
      successSignal: "Student explains why the aircraft must point into the wind.",
      supportDecision: "Return to the river diagram and relabel the arrows with the new context."
    }
  ],
