...
export const lesson17MomentumImpulseCarousel: EduCarouselConfig = {
  ...
  slides: [
    ...
    },
    {
      ...
      type: "question_mcq",
      title: "Bouncing Ball",
      question: "A 0.5kg ball hits a wall at 10m/s and bounces back at 8m/s. The collision lasts 0.02s. Predict: is the force from the wall large or small? In which direction?",
      imageLayout: "left",
    ...
    },
    {
      ...
      type: "question_mcq",
      title: "Braking Car",
      question: "A 1000kg car moving at 20m/s brakes to rest in 5s. Find the average braking force.",
      imageLayout: "left",
